...
class SetInvoiceAsRejectedCommandTest extends TestCase
{
    ...
    public function test_invoice_does_not_exist(): void
    {
        ...
        $command = new SetInvoiceAsRejectedCommand;
    ...
    public function test_invoice_is_rejected(): void
    {
        ...
        $this->mock(ApprovalFacadeInterface::class, function (MockInterface $mock) use ($invoice) {
            $mock->shouldReceive('reject')->andReturnTrue()->once();
        });
